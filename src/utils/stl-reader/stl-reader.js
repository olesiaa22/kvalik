import DataStream from "../DataStream.js/DataStream.js";
import StlAsciiReader from "./stl-ascii-reader.js";
import StlBinaryReader from "./stl-binary-reader.js";
...
var StlReader = (function () {
  ...
  function isBinary(ds) {
    ...
    if (
      fileSize ==
      HEADER_SIZE + TRI_COUNT_SIZE + numTriangles * PER_TRI_SIZE
    ) {
      return true;
    }
   ...
   * @returns {{vn: Float32Array, vertices: Float32Array, normals: Float32Array}} {vn, vertices, normals}
   */
